...
import UIKit
import RealmSwift
class StudentModel: Object {//集成自realm的Object类
...
extension StudentModel {
    /// 获取 所保存的 Student
      public class func getStudents() -> Results<StudentModel> {
          let defaultRealm = StudentRealmTool.getDB()
          return defaultRealm.objects(StudentModel.self)
      }
}
...
class BookModel: Object {
    ...
    let owners = LinkingObjects(fromType: StudentModel.self, property: "books")
}


class StudentRealmTool: Object {
